...
L = {'ylabel': 'Intelligence Index (Artificial Analysis)', 'title': 'AI Model Capability Over Time — A Single Number', 'sub': 'independent measurement of {n} models ({lo} – {hi})  ·  yellow steps: best available at the time', 'growth': 'Last 12 months\n{a:.0f} → {b:.0f}  ({k:.1f}x)', 'cloud': 'other measured models', 'credit': 'Source: artificialanalysis.ai  ·  Compiled by Prof. Dr. Oğuz Ergin'}
