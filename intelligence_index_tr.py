...
L = {'months': ['Oca', 'Şub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Ağu', 'Eyl', 'Eki', 'Kas', 'Ara'], 'ylabel': 'Zekâ Endeksi (Artificial Analysis)', 'title': 'Tek Sayıyla Yapay Zeka Modellerinin Başarımı', 'sub': '{n} modelin bağımsız ölçümü ({lo} – {hi})  ·  sarı: o güne kadarki en iyi  ·  yeşil kesikli: en iyi açık ağırlıklı', 'growth': 'Son 12 ayda\n{a:.0f} → {b:.0f}  ({k:.1f}×)\nAçık ağırlık en iyi: {ao:.0f}  (makas {fark:.1f})', 'cloud': 'diğer ölçülen modeller', 'front_all': 'o güne kadarki en iyi', 'front_open': 'en iyi açık ağırlıklı', 'credit': 'Kaynak: artificialanalysis.ai  ·  Derleyen: Prof. Dr. Oğuz Ergin'}
