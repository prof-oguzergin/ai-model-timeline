...
# Veri kaynagi: artificialanalysis.ai  (468 model, 2022-11-30 - 2026-09-01)
...
L = {'ylabel': 'Zekâ Endeksi (Artificial Analysis)', 'title': 'Yapay Zeka Modellerinin Başarımı — Tek Sayıyla', 'sub': '{n} modelin bağımsız ölçümü ({lo} – {hi})  ·  sarı: o güne kadarki en iyi  ·  yeşil kesikli: en iyi açık ağırlıklı', 'growth': 'Son 12 ayda\n{a:.0f} → {b:.0f}  ({k:.1f}×)\nAçık ağırlık en iyi: {ao:.0f}  (makas {fark:.1f})', 'cloud': 'diğer ölçülen modeller', 'front_all': 'o güne kadarki en iyi', 'front_open': 'en iyi açık ağırlıklı', 'credit': 'Kaynak: artificialanalysis.ai  ·  Derleyen: Prof. Dr. Oğuz Ergin'}
