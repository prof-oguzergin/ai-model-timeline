...
L = {'ylabel': 'Video Kalite Elo (Artificial Analysis Arena)', 'title': 'Video Üretme Modellerinin Başarımı — Tek Sayıyla', 'sub': '{n} video üretme modelinin körlemesine insan oylamasıyla Elo puanı ({lo} – {hi})  ·  sarı merdiven: o güne kadarki en iyi', 'growth': 'Son 12 ayda\n{a:.0f} → {b:.0f}  (+{d:.0f} puan)', 'cloud': 'diğer ölçülen modeller', 'credit': 'Kaynak: artificialanalysis.ai (Video Arena)  ·  Derleyen: Prof. Dr. Oğuz Ergin'}
...
plt.tight_layout()
plt.savefig("video_elo_tr.png", dpi=105, facecolor="#0d1117", bbox_inches="tight")
print("kaydedildi: video_elo_tr.png", len(df), " sinir:", len(fr))
